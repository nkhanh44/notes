...
1. [Self-editing](#self-editing)
2. [Organizing large docs](#organizing-large-docs)
3. [Illustrating](#illustrating)
4. [Creating sample code](#creating-sample-code)
...
_Note:_ For smaller projects, such as team documentation or a small open source project, you might find the highlights are all you need.
